...
ITエンジニアをターゲットとして、キャリアの築き方、セルフマーケティングについて、お金について、健康の話など多岐にわたる内容を筆者の経験を元にアドバイスしてくれる本です。  
全てを鵜呑みにする必要はありませんが、参考になる部分が多く良い本です。  
4半期の終わりのタイミングなので、改めて自分のスキルセットや今後のキャリアパスを検討したいと思い、改めて読んでみました。
